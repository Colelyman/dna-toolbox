...
def genFirstToLast(firstBWT, BWT):
    ...
    '''bpIndexes["B"] = firstBWT.index("B")
    bpIndexes["D"] = firstBWT.index("D")
    bpIndexes["E"] = firstBWT.index("E")
    bpIndexes["F"] = firstBWT.index("F")
    bpIndexes["H"] = firstBWT.index("H")
    bpIndexes["I"] = firstBWT.index("I")
    bpIndexes["J"] = firstBWT.index("J")
    bpIndexes["K"] = firstBWT.index("K")
    bpIndexes["L"] = firstBWT.index("L")
    bpIndexes["M"] = firstBWT.index("M")
    bpIndexes["N"] = firstBWT.index("N")
    bpIndexes["O"] = firstBWT.index("O")
    bpIndexes["P"] = firstBWT.index("P")
    bpIndexes["Q"] = firstBWT.index("Q")
    bpIndexes["R"] = firstBWT.index("R")
    bpIndexes["S"] = firstBWT.index("S")
    bpIndexes["U"] = firstBWT.index("U")
    bpIndexes["V"] = firstBWT.index("V")
    bpIndexes["W"] = firstBWT.index("W")
    bpIndexes["X"] = firstBWT.index("X")
    bpIndexes["Y"] = firstBWT.index("Y")
    bpIndexes["Z"] = firstBWT.index("Z")'''
    for i in BWT:
